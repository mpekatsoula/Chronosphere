...
void test_verilog_parser (string filename) {
  ...
  do {
    ...
    valid = vp.read_cell_inst (cellType, cellInst) ;
...
int wake_parser(string filetype, string filename) {
  ...
  if (filetype == string("verilog")) {
   // cout << "Parsing verilog..." << endl ;
  ...
  else if (filetype == string("sdc")) {
    cout << "Parsing sdc..." << endl ;  
    test_sdc_parser (filename) ;
  ...
  else if (filetype == string("timing")) {
    cout << "Parsing timing..." << endl ;  
    test_timing_parser (filename) ;
    cout << "Finished parsing timing." << endl ;
  }
  else if (filetype == string("ceff")) {
    cout << "Parsing ceff..." << endl ;  
    test_ceff_parser (filename) ;
    ...
    cout << "Unknown format " << filetype << endl ;
